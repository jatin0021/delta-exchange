...
const Options = ({ mode }) => {
  ...
  const optionsData = [
    ...
    // ... repeat data for visual fullness or just use the mock data structure
    {
      bidQty: 7.79,
      bidPrice: 5291,
      askPrice: 5348,
    ...
    },
    {
     ...
     // Added a few repeats to match original volume of rows approx
     {
      bidQty: 7.79,
      bidPrice: 5682,
      askPrice: 5743,
  ...
  return (
    <div className={`w-full min-h-screen p-4 ${containerClasses}`}>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <span className={`${labelClasses} text-sm`}>Time to Expiry: 0d:17h:50m</span>
      </div>

      {/* --- Options Table with Horizontal Scrolling --- */}
      <div className="overflow-x-auto">
        <table className="w-full border-collapse text-sm min-w-[1200px]">
          <thead>
            <tr className={tableHeaderClasses}>
              <th colSpan="7" className="py-3 px-4 text-left text-orange-400">Calls</th>
              <th className="py-3 px-4 text-center border-x border-gray-700 text-gray-400">Strike</th>
              <th colSpan="7" className="py-3 px-4 text-right text-blue-400">Puts</th>
            </tr>
            <tr className={tableHeaderClasses}>
